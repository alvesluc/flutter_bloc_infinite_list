...
void main() {
  group('PostBloc', () {
    const mockPosts = [Post(id: 1, title: 'title', body: 'body')];
    const extraMockPosts = [Post(id: 2, title: 'title', body: 'body')];
    ...
    group('PostFetched', () {
      ...
      blocTest<PostBloc, PostState>(
          'emits failure status when http fetches posts and throw an exception',
          setUp: () {
      ...
      blocTest<PostBloc, PostState>(
        ...
        'no additional posts are fetched',
        setUp: () {
          when(() => httpClient.get(any())).thenAnswer(
